--------------------------------------------
DDC Ocr Restful Api Sample - python ReadMe
--------------------------------------------
...
1. Update strApiKey in config.properties with your own secret key. For details on how to get a secret key, please check
   https://developer.dynamsoft.com/authenticating-to-the-cloud-api
2. Run the sample from the command line use the python command:
   python Program.py
